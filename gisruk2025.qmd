...
The first option, cycle track that is at carriage level, has additional advantages over stepped cycleway, being often cheaper to construct [with no new tarmac required in many cases](https://www.transport.gov.scot/media/50323/cycling-by-design-update-2019-final-document-15-september-2021-1.pdf#page=76).
...
Corridor is the width of the carrieageway plus any built roadside features, such as footways.
...
After the previous steps we categorised roads into three groups based on the available width:
