...
Nevertheless, it is important to note that the british design principles and classification of cycling infrastructure cannot be universally applied to all global contexts.
Their suitability varies, and they should be used with careful consideration of local conditions and cycling infrastructure maturity.
Future research should focus on developing context-specific classifications to better address the diverse needs of different urban environments.
