...
los_table_long_missing <- tibble::tribble(
  ...
  # Painted Cycle Lane -> Cycle Lane
  "30 mph", "4000+", "Painted Cycle Lane", 1, # CbD: 30-50kph, 4000+, Cycle Lane = ● (1)
  "40 mph", "4000+", "Painted Cycle Lane", 1, # CbD: 50-65kph, 2000+, Cycle Lane = ● (1)
  # Removed duplicate row here
  "40 mph", "2000 to 3999", "Painted Cycle Lane", 1, # CbD: 50-65kph, 2000+, Cycle Lane = ● (1)
  "40 mph", "0 to 999", "Painted Cycle Lane", 2, # CbD: 50-65kph, 0-1000, Cycle Lane = ●● (2) - Updated from 1
  "40 mph", "1000 to 1999", "Painted Cycle Lane", 1, # CbD: 50-65kph, 1000-2000, Cycle Lane = ● (1)
  "50 mph", "4000+", "Painted Cycle Lane", 1, # CbD: 65-80kph, 1000+, Cycle Lane = ● (1) - Updated from 0
  "50 mph", "2000 to 3999", "Painted Cycle Lane", 1, # CbD: 65-80kph, 1000+, Cycle Lane = ● (1) - Updated from 0
  "50 mph", "0 to 999", "Painted Cycle Lane", 2, # CbD: 65-80kph, 0-1000, Cycle Lane = ●● (2) - Updated from 0
  "50 mph", "1000 to 1999", "Painted Cycle Lane", 1, # CbD: 65-80kph, 1000+, Cycle Lane = ● (1) - Updated from 0
  ...
  "60+ mph", "0 to 999", "Painted Cycle Lane", 0, # CbD: 80kph+, All flows, Cycle Lane = X (0)
  "60+ mph", "1000 to 1999", "Painted Cycle Lane", 0, # CbD: 80kph+, All flows, Cycle Lane = X (0)

  # Segregated Track (narrow) -> Light Segregation
  "30 mph", "4000+", "Segregated Track (narrow)", 2, # CbD: 30-50kph, 4000+, Light Seg = ●● (2) - Updated from 1
  "40 mph", "4000+", "Segregated Track (narrow)", 1, # CbD: 50-65kph, 2000+, Light Seg = ● (1)
  ...
  "40 mph", "1000 to 1999", "Segregated Track (narrow)", 1, # CbD: 50-65kph, 1000-2000, Light Seg = ● (1)
  "50 mph", "4000+", "Segregated Track (narrow)", 1, # CbD: 65-80kph, 1000+, Light Seg = ● (1) - Updated from 0
  "50 mph", "2000 to 3999", "Segregated Track (narrow)", 1, # CbD: 65-80kph, 1000+, Light Seg = ● (1) - Updated from 0
  ...
  "60+ mph", "0 to 999", "Segregated Track (narrow)", 0, # CbD: 80kph+, All flows, Light Seg = X (0)
  "60+ mph", "1000 to 1999", "Segregated Track (narrow)", 0, # CbD: 80kph+, All flows, Light Seg = X (0)

  # Segregated Track (wide) -> Cycle Track at Carriageway Level
  "30 mph", "4000+", "Segregated Track (wide)", 3, # CbD: 30-50kph, 4000+, C'way Track = ●●● (3) - Updated from 2
  "30 mph", "2000 to 3999", "Segregated Track (wide)", 3, # CbD: 30-50kph, 2000-4000, C'way Track = ●●● (3) - Updated from 2
  "30 mph", "0 to 999", "Segregated Track (wide)", 3, # CbD: 30-50kph, 0-1000, C'way Track = ●●● (3)
  "30 mph", "1000 to 1999", "Segregated Track (wide)", 3, # CbD: 30-50kph, 1000-2000, C'way Track = ●●● (3) - Updated from 2
  "40 mph", "4000+", "Segregated Track (wide)", 3, # CbD: 50-65kph, 2000+, C'way Track = ●●● (3) - Updated from 1
  "40 mph", "2000 to 3999", "Segregated Track (wide)", 3, # CbD: 50-65kph, 2000+, C'way Track = ●●● (3) - Updated from 1
  "40 mph", "0 to 999", "Segregated Track (wide)", 3, # CbD: 50-65kph, 0-1000, C'way Track = ●●● (3) - Updated from 1
  "40 mph", "1000 to 1999", "Segregated Track (wide)", 3, # CbD: 50-65kph, 1000-2000, C'way Track = ●●● (3) - Updated from 1
  "50 mph", "4000+", "Segregated Track (wide)", 3, # CbD: 65-80kph, 1000+, C'way Track = ●●● (3) - Updated from 1
  "50 mph", "2000 to 3999", "Segregated Track (wide)", 3, # CbD: 65-80kph, 1000+, C'way Track = ●●● (3) - Updated from 1
  "50 mph", "0 to 999", "Segregated Track (wide)", 3, # CbD: 65-80kph, 0-1000, C'way Track = ●●● (3) - Updated from 1
  "50 mph", "1000 to 1999", "Segregated Track (wide)", 3, # CbD: 65-80kph, 1000+, C'way Track = ●●● (3) - Updated from 1
  # For 60+ mph, the CbD shows different LoS for 80-95kph vs 95-110kph. Using the lower LoS (from 95-110kph) for a conservative "60+" value.
  "60+ mph", "4000+", "Segregated Track (wide)", 1, # CbD: 95-110kph, All flows, C'way Track = ● (1)
  "60+ mph", "2000 to 3999", "Segregated Track (wide)", 1, # CbD: 95-110kph, All flows, C'way Track = ● (1)
  "60+ mph", "0 to 999", "Segregated Track (wide)", 1, # CbD: 95-110kph, All flows, C'way Track = ● (1)
  "60+ mph", "1000 to 1999", "Segregated Track (wide)", 1, # CbD: 95-110kph, All flows, C'way Track = ● (1)
  ...
  "30 mph", "0 to 999", "Mixed Traffic Street", 2, # CbD: 30-50kph, 0-1000, Mixed = ●● (2)
  "30 mph", "1000 to 1999", "Mixed Traffic Street", 2, # CbD: 30-50kph, 1000-2000, Mixed = ●● (2)
  "30 mph", "2000 to 3999", "Mixed Traffic Street", 1, # CbD: 30-50kph, 2000-4000, Mixed = ● (1)
  "30 mph", "4000+", "Mixed Traffic Street", 1, # CbD: 30-50kph, 4000+, Mixed = ● (1)
