...
los_table_long_missing <- tibble::tribble(
  ...
  # --- 30 mph ---
  "30 mph", "0 to 999", "Segregated Track (narrow)", 2, # CbD: 50-65kph, 0-1000, Light Seg = ●● (2)
  "30 mph", "1000 to 1999", "Segregated Track (narrow)", 2, # CbD: 50-65kph, 1000-2000, Light Seg = ●● (2)
  "30 mph", "2000 to 3999", "Segregated Track (narrow)", 1, # CbD: 50-65kph, 2000-4000, Light Seg = ● (1)
  ...
  "40 mph", "4000+", "Segregated Track (narrow)", 1, # CbD: 50-65kph, 2000+, Light Seg = X (0)
  # --- 50 mph ---
  ...
  "20 mph", "1000 to 1999", "Mixed Traffic Street", 2, # CbD: 0-30kph, 0-2000, Mixed = ●●● (3)
  "20 mph", "2000 to 3999", "Mixed Traffic Street",1, # CbD: 0-30kph, 2000-4000, Mixed = ● (1)
  ...
  # --- 60+ mph ---
  "60+ mph", "0 to 999", "Mixed Traffic Street", 1, # CbD: 80kph+, All flows, Mixed = X (0)
